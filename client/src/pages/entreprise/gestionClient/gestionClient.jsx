...
import "./gestionClient.css" // Vous copiez le même CSS       
        ...
        if (data.success) {    
          ...
          const companyClients = data.data  
            ...
            .map(customer => ({    
              ...
              adresse: customer.physical_user_id?.adresse_principale || 'N/A',    
  ...
  const handleAddSubmit = async (e) => {      
    ...
    try {    
      ...
      if (result.success) {    
        ...
        window.location.reload(); // Simplification pour recharger les données  
      } else {    
