...
import { Eye, EyeOff, User, Building, Mail, Lock, Phone, MapPin, AlertCircle, CheckCircle, Link } from "lucide-react"      
...
const SignupPage = () => {      
  ...
  // PhysicalUser avec région obligatoire    
  const [physicalData, setPhysicalData] = useState({        
    ...
    telephone_principal: "",        
    adresse_principale: "",        
    ville: "", // Select avec Casablanca uniquement  
    region_principale: "", // Select avec les 4 régions  
  })     
    
  // MoralUser avec ville comme select  
    ...
    try {      
      const requestData = {      
        ...
        profile: userType === 'PHYSIQUE' ? {      
          ...
          ville: currentData.ville, // Pour particuliers  
          ...
          telephone_principal: currentData.telephone_principal,      
          adresse_principale: currentData.adresse_principale,      
          ville: currentData.ville, // Utiliser la valeur sélectionnée  
          region_principale: currentData.region_principale      
        }      
      }      
      ...
      if (data.success) {    
        // MODIFIÉ: Vérifier si une vérification d'email est requise  
        if (data.requiresVerification) {  
          navigate('/verify-email', {   
            state: { email: currentData.email }   
          });  
        } else {  
          // Connexion automatique pour les autres cas  
          if (data.data.token) {  
      ...
      <div className="signup-content">      
        <div className="signup-card">      
          ...
          <form onSubmit={handleSubmit} className="signup-form">      
            ...
            {/* Section particuliers avec ville et région */}    
            {userType === "PHYSIQUE" && (      
              <div className="form-section">      
            ...
            {/* Section entreprises avec ville comme select */}      
            {userType === "MORAL" && (        
              <div className="form-section">        
                <div className="form-group">        
            ...
            <div className="form-section">          
              ...
              {/* Ville et région pour les entreprises comme selects */}      
              {userType === "MORAL" && (      
                <>      
                  <div className="form-group">          
                    <label htmlFor="ville" className="form-label">          
