...
const getClients = async (req, res) => {
  try {
    // CORRIGÉ: Récupérer tous les clients (pas seulement ACTIF)
    ...
    const formattedClients = clients.map(client => {
      ...
      if (client.physical_user_id) {
        clientData.user_info = {
          ...
          ville: client.physical_user_id.ville,
        ...
        clientData.user_info = {
          ...
          ville: client.moral_user_id.ville,
  ...
  try {
    ...
    const formattedEmployees = employees.map(employee => ({
      ...
      user_info: {
        ...
        ville: employee.physical_user_id.ville,
...
const updateUser = async (req, res) => {
  try {
    ...
    // CORRIGÉ: Récupérer les utilisateurs physiques/moraux AVANT de les utiliser
    ...
    if (statut && ['ACTIF', 'INACTIF', 'SUSPENDU', 'EN_ATTENTE'].includes(statut)) {  
      ...
      // CORRIGÉ: Synchroniser le statut Customer  
