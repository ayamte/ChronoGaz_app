...
const login = async (req, res) => {      
  try {      
    ...
    // MODIFIÉ: Déterminer le type d'utilisateur et informations additionnelles  
    let userType = null;  
    let additionalInfo = {};  
  
    // Vérifier s'il s'agit d'un utilisateur physique  
    ...
    // Vérifier s'il s'agit d'un utilisateur moral (entreprise)  
    ...
    // MODIFIÉ: Réponse enrichie avec le type et les informations additionnelles  
    res.json({      
      success: true,      
